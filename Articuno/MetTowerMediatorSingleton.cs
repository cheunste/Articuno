...
namespace Articuno
{
    class MetTowerMediatorSingleton
    {
        ...
        private MetTowerMediatorSingleton()
        {
            met1Switched = false;
            met2Switched = false;
        }

        public static MetTowerMediatorSingleton Instance { get { return Nested.instance; } }

        private class Nested
        {
            //Explicit static constructor to tell C# compiler not to mark type as beforefiled init
            static Nested() { }
            internal static readonly MetTowerMediatorSingleton instance = new MetTowerMediatorSingleton();
        }
